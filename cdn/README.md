...
```html
<script src="https://cdn.jsdelivr.net/gh/algorisys-oss/tinyfly@v0.53.0/cdn/tinyfly.iife.js"></script>
<script>
...
```html
<script type="module">
  import { live } from 'https://cdn.jsdelivr.net/gh/algorisys-oss/tinyfly@v0.53.0/cdn/tinyfly.esm.js'
  live.to('.box', { x: 200, duration: 1 })
</script>
```

Pin a version tag (`@v0.53.0`) in production. `@main` follows the latest publish
